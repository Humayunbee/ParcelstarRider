...
import com.easyflight.rider.Adaptar.ReturnParcelAdaptar.ReturnParcels;
import com.easyflight.rider.Model.PickupRequest.PickupRequestAccept;
import com.easyflight.rider.Model.Return.ReturnParcel;
...
public class ReturnMenuClickListner implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (percel.getParcelStatus().equals("Return Branch  Run Start")) {
            ...
            popupMenu.getMenu().findItem(R.id.m_request_reschedule).setVisible(tu);
            popupMenu.getMenu().findItem(R.id.m_request_complete).setVisible(false);

            ...
            public void onResponse(Call<DeliveryContainer> call, Response<DeliveryContainer> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (parcelInfos.size() > 0) {
                        ...
                        RequestDeliveryAdaptar adaptar = new RequestDeliveryAdaptar(parcelInfos, getApplicationContext(), RequestDeliveryActivity.this ,new RequestDeliveryAdaptar.OnItemClickListener() {
                            @Override
